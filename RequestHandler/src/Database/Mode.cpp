...
namespace db
{
		...
		)
	{
		this->rawQuery
		(
			"CREATE TABLE IF NOT EXISTS " + this->getTableName() + " (id INTEGER PRIMARY KEY AUTOINCREMENT, id_reference INTEGER NOT NULL, id_destination INTEGER NOT NULL, id_user INTEGER NOT NULL, "
